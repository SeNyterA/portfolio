  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            className="absolute bottom-0 left-1/2 translate-y-8 uppercase translate-x-[-50%] font-light"
          >
            Drag to navigate
          </motion.div>
        </motion.div>
      ...
      <AnimatePresence>
        {loading && (
          <motion.div
            className="fixed top-0 flex bg-black/95 items-center flex-col gap-2 justify-center z-[200] overflow-hidden"
            initial={{
              inset: 0,
              borderRadius: 0,
            }}
          ...
          >
            ...
            <motion.span className="ml-2 text-4xl bg-gradient-to-r font-semibold from-blue-200 via-yellow-200 to-indigo-200 bg-clip-text text-transparent">
